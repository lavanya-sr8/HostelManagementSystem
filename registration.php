   ...
   if(!preg_match($nameregex, $name)){
    ...
    $errmsg = "*Email must end with @psgtech.ac.in";
     ...
     elseif (!preg_match($passwordregex, $password)) {
         $errmsg="*Password must contain minimum 8 and maximum 16 characters, at least one uppercase letter, one lowercase letter, one number and one special character";
     }
     else{
      ...
      <form action="registration.php"   method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your regno" name="regno" value="<?php echo "$regno"; ?>" pattern="^[0-9]{2}([A-Za-z]{1}[0-9]{3}|[A-Za-z]{2}[0-9]{2,3})$" required>
          </div>
          <div class="input-box">
            <span class="details">Email</span>
            <input type="text" placeholder="Enter your email" name="email" value="<?php echo "$email"; ?>" pattern="[A-Za-z0-9._%+-]+@psgtech\.ac\.in" title="Email must end with @psgtech.ac.in" required>
          </div>
          <div class="input-box">
